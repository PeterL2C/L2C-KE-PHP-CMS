...
$pages = db_select("SELECT * FROM Pages"); // bud cez db_select $pages = db_select a dole potom foreach $pages as $page...... ->title
      ...
      <div class="row">
        ...
        <div class="col-sm-8 blog-main">
          ...
          <?php foreach($pages as $page){ ?>
            <?php $user= db_select("SELECT * FROM users WHERE ID =".$page->User_ID);?>
